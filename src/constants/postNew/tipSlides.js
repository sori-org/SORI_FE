...
import CutToonIcon from "../../assets/img_cutToon.svg";
    ...
    4: [
        {
            ...
            title_image: InstagramIcon,
            main_image: Tip_2_2,
            description: "♥️ 컷만화는 쉽게 관심을 유도할 수 있는 방법이에요. \n" +
                "복잡한 내용을 간단한 이야기로 전달 가능하기 때문에 누구에게나 이해하기 쉽게 전달할 수 있어요. \n" +
                "추천하는 sns는 인스타그램입니다! \n" +
                "이 방법은 트위터나 네이버카페 특성에 어울리지 않아요.♥",
        },
        {
            title: "컷 만화",
            title_image: CutToonIcon,
            main_image: Tip_2_2,
            description: "♥️ 컷만화는 쉽게 관심을 유도할 수 있는 방법이에요. \n" +
                "복잡한 내용을 간단한 이야기로 전달 가능하기 때문에 누구에게나 이해하기 쉽게 전달할 수 있어요. \n" +
                "추천하는 sns는 인스타그램입니다! \n" +
